                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="current-page"><a href="index.php?controller=admin&action=monan"><i class="fas fa-utensils me-2"></i>Món ăn</a>
                                </li>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped jambo_table bulk_action">
                                            <thead>
                                                <tr class="headings">
                                                    <th class="column-title mede">ID </th>
                                                    <th class="column-title mede">Tên Món</th>
                                                    <th class="column-title mede">Mô Tả</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($id_mon_an as $key => $value) : ?>
                                                    <tr class="pointer">
                                                        ...
                                                        <td><?php echo $mon_an[$key]; ?></td>
                                                        <td><?php echo $mo_ta[$key]; ?></td>
                                                        <td><?php echo $gia[$key]; ?></td>
                                                        <td><?php echo $ten_loai[$key]; ?></td>
                                                        <td><?php echo $noi_bat[$key]; ?></td>
                                                        <td><?php echo $con_hang[$key]; ?></td>
